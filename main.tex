...
\geometry{left=1.25cm,right=1.25cm,top=1.1cm,bottom=0.9cm,columnsep=1.2cm}
...
\begin{document}
\name{RASHED AZAD}
\tagline{\textbf{Embedded Software Developer} – {\small\normalfont ACS Skills Assessment: Positive | Relocating to Australia (186 / 491 Visa)}}
...
\begin{paracol}{2}
	...
	{\small
	Senior Embedded Software Developer with 6+ years of experience in real-time and system-critical 
	applications, particularly in robotics and embedded Linux environments. Proven expertise 
	in modern C++ and Rust, with a strong focus on performance, scalability, and algorithmic
	efficiency. Actively relocating to Australia's high-tech sector: ACS Skills Assessment 
	returned a \emph{positive} result for ANZSCO 261313 Software Engineer, IELTS scored 7.0+
	across all bands, and all 491 Skilled Visa requirements are fulfilled (application in progress).
	}

	\cvsection{Experience}

	\cvevent{Senior Embedded Software Engineer}{Nova Measuring Instruments GmbH}{January 2023 -- Ongoing}{Bad Urach, Germany}
	{\small\color{LightGrey}Promoted from Embedded Software Engineer in July 2026\par}
	\vspace{0.15em}
	\begin{itemize}
		\item Deployed an OPC UA-based communication layer between GUI and backend for secure, real-time system interaction.
	...
	\begin{itemize}
		\item \textbf{Citizenship:} German $\cdot$ \textbf{Driving Licence:} German Class B (B197)
		\item \textbf{Australian Migration:} ACS positive (ANZSCO 261313) $\cdot$ IELTS 7.0+ all bands $\cdot$ 491 application in progress
		\item \textbf{Availability:} Available for relocation to Australia
	\end{itemize}
	...
	\cvevent{M.Sc.\ in Mechatronics}{University of Siegen}{2015 -- 2019}{Siegen, Germany}
