...
\begin{paracol}{2}
	...
	{\small
	Embedded Software Developer with 6+ years of experience in real-time and system-critical applications,
	particularly in robotics and embedded Linux environments. Proven expertise in modern C++ and Rust, with a
	strong focus on performance, scalability, and algorithmic efficiency. Actively relocating to Australia's
	high-tech sector: ACS Skills Assessment returned a \emph{positive} result for ANZSCO 261313 Software Engineer,
	IELTS scored 7.0+ across all bands, and all 491 Skilled Visa requirements are fulfilled (application in progress).
	}
